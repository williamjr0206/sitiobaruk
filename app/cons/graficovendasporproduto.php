...
// Consulta SQL
$sql = "SELECT produto.descricao, SUM(venda.quantidade*produto.preco) from venda inner join produto on venda.idproduto=produto.idproduto where venda.data between '$datainicial' and '$datafinal' group by produto.descricao";
$res = $con->query($sql);
